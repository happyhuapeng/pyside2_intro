...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.center_widget.setStyleSheet('*{background: white; color: red}')
        # 中心控件布局
        ...
        self.dock_layout = QtWidgets.QVBoxLayout() # 画布
        self.dock_label = QtWidgets.QLabel('这是放在Dock1中的标签') # Label控件
        self.dock_layout.addWidget(self.dock_label) # 把控件放入画布中
        self.dock_container.setLayout(self.dock_layout) # 把画图放入容器中
        self.dock.setWidget(self.dock_container) # 把容器放入Dock窗口
        ...
        self.statusBar().setStyleSheet('*{background: blue; color: white}')
